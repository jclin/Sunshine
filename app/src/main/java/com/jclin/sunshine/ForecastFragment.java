...
public class ForecastFragment extends Fragment
{
    ...
    {
        private static final int daysInForecast = 7;
        ...
        protected String[] doInBackground(String... params)
        {
            ...
            try
            {
                Uri.Builder uriBuilder = new Uri.Builder()
                    ...
                    .appendQueryParameter("cnt", String.valueOf(daysInForecast));
                ...
                return getWeatherDataFromJson(buffer.toString(), daysInForecast);
            }
        ...
        protected void onPostExecute(String[] strings)
        {
            ...
            _forecastAdapter.addAll(strings);
        }
